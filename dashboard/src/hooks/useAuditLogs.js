...
export function useAuditLogs(filters) {
    ...
    return useQuery({
        ...
        queryFn: async () => {
            const params = Object.fromEntries(Object.entries({ ...rest, limit, offset }).filter(([, v]) => v !== '' && v !== undefined));
...
export function useExportAuditLogs() {
    return useMutation({
        mutationFn: async ({ filters, format }) => {
            const params = Object.fromEntries(Object.entries({ ...filters, format }).filter(([, v]) => v !== '' && v !== undefined));
