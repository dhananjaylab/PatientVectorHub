...
describe('Pagination', () => {
  it('renders nothing when everything fits on one page', () => {
    const { container } = render(<Pagination total={10} limit={50} offset={0} onOffsetChange={vi.fn()} />)
  ...
  it('disables Next on the last page', () => {
    render(<Pagination total={120} limit={50} offset={100} onOffsetChange={vi.fn()} />)
  ...
  it('calls onOffsetChange with the next page offset', async () => {
    ...
    render(<Pagination total={120} limit={50} offset={0} onOffsetChange={onOffsetChange} />)
  ...
  it('never goes below offset 0 on Prev', async () => {
    const user = userEvent.setup()
    const onOffsetChange = vi.fn()
    render(<Pagination total={120} limit={50} offset={20} onOffsetChange={onOffsetChange} />)
